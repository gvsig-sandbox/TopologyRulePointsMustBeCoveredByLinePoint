                ...
                if point1.getGeometryType().getName() == "Point2D":
                    ...
                    for featureReference in theDataSet2.query(buffer1):
                        ...
                        if line2.getGeometryType().getName() == "Line2D":
                            if buffer1.contains(line2): #buffer1.intercept(line2): improving
                                contains = True
                                break
                        else:
                            if line2.getGeometryType().getName() == "MultiLineLine2D":
                                ...
                                for i in range(0, n2 + 1):
                                    ...
                                    if buffer1.contains(curve2): # buffer1.intercept(curve2): improving
                                        contains = True
                                        break
                    if not contains:
                        report.addLine(self,
                    ...
                    if point1.getGeometryType().getName() == "MultiPoint2D":
                        ...
                        for i in range(0, n1 + 1):
                            ...
                            for featureReference in theDataSet2.query(buffer1):
                                ...
                                line2 = feature2.getDefaultGeometry()
                                if line2.getGeometryType().getName() == "Line2D":
                                    if buffer1.contains(line2): #buffer1.intercept(line2): interception study
                                        contains = True
                                        break
                                else:
                                    if line2.getGeometryType().getName() == "MultiLineLine2D":
                                        ...
                                        for j in range(0, n2 + 1):
                                            ...
                                            if buffer1.contains(curve2): # .intercept(curve2):
                                                contains = True
                                                break
                            if not contains:
                                report.addLine(self,
